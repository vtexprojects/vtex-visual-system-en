> **Locale-scoped export** — this repo contains the English (EN) slice of the VTEX Visual System design system (shared tokens/components/guidelines + only the `assets/images/en/` image library). Generated from `VTEX Visual System_Git.zip`.
